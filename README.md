# Домашнее задание к занятию 4 «Оркестрация группой Docker контейнеров на примере Docker Compose» - `Иншаков Владимир`
...
Были созданы два контейнера: на базе centos7 и debian. Для работы проброшена директория ($(pwd)) в data/
Все изменения в директории отображаются и в контейнерах, и на самой виртуалке.
![Screen_4_1](https://github.com/MrVanG0gh/05-virt-03-docker-intro/blob/main/Screenshots/Screenshot_4_1.png)
